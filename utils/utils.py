...
def cal_ssim(img1, img2):
    # Ensure images are in the correct format and range
    img1_np = img1.cpu().numpy()
    img2_np = img2.cpu().numpy()

    # Specify the data range based on the maximum value of img1 or img2
    data_range = img1_np.max() - img1_np.min()

    # Calculate SSIM
    return metrics.structural_similarity(img1_np, img2_np, data_range=data_range)
