...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 11 15:18:23 2024
...
def parse_args():
    ...
    parser.add_argument("--angin", type=int, default=2, help="input angular resolution")
    parser.add_argument("--angout", type=int, default=7, help="output angular resolution")
    parser.add_argument("--factor", type=int, default=7, help="output angular resolution")
    ...
    parser.add_argument("--model_name", type=str, default='HCI_TRNS_2x2xSR_7x7_epoch')
    ...
    parser.add_argument('--save_path', type=str, default='./output_HCI/')
...
if __name__ == '__main__':
    cfg = parse_args()
    demo_test(cfg)
>>>>>>> 6f455e2 (Add all project files)
>>>>>>> 9279145 (Initial commit)
