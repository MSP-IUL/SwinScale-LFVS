...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='HCI_TRNS')
    parser.add_argument('--trainset_dir', type=str, default='/home/mzrdu/Downloads/Learning purpose/MEO Synthetic/TrainData_HCI_2x2-7x7/')
    parser.add_argument('--testset_dir', type=str, default='/home/mzrdu/Downloads/Learning purpose/MEO Synthetic/TestData_RE_HCI_2x2-7x7/')
    ...
    parser.add_argument('--model_path', type=str, default='../checkpoint/HCI_TRNS')
    parser.add_argument('--seed', type=int, default=9786, help='random seed')
...
# Print the number of parameters in millions (M)
